...
# Code in this workflow is written as if the cwd is the root of the code repo.
# quarto render will set the wd to the dir of the qmd file so it is reset here
setwd("../.")
...
hh_file <- "test/some_data_2042-07-13.csv"
write.csv(hitchhiker_data, file = hh_file, row.names = FALSE)

# Optional: convert relative configPath to an absolute path
# params$configPath <- normalizePath(params$configPath, mustWork = TRUE)
